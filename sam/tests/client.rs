...
// //
// //     let result: Result<Vec<SamStudent>, SamClientError> = client.students();
// //
// //     assert!(
// //         result.is_err(),
...
//
//         let client = client;
//         let result: Result<(), SamClientError> = client.login(&credentials);
//         assert_eq!(
...
//
//             let err: SamClientError = result.unwrap_err();
//             assert!(
