...
mod tests {
    ...
    fn viola_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Viola)
    ...
    fn cello_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Cello)
    ...
    fn flute_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Flute)
    ...
    fn oboe_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Oboe)
    ...
    fn bassoon_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Bassoon)
    ...
    fn clarinet_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Clarinet)
    ...
    fn bass_clarinet_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::BassClarinet)
    ...
    fn saxophone_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Saxophone)
    ...
    fn trumpet_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Trumpet)
    ...
    fn tuba_matches_known_thresholds() {
        let requirements = InstrumentRequirements::for_instrument(&Instrument::Tuba)
