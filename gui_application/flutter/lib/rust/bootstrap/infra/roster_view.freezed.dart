...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RetrieveAllAvailableStudentsOutcome&&const DeepCollectionEquality().equals(other.field0, field0));
}
...
@override
String toString() {
  return 'RetrieveAllAvailableStudentsOutcome(field0: $field0)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<StudentSummaryDto> field0)?  success,TResult Function( ErrorReportDto field0)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case RetrieveAllAvailableStudentsOutcome_Success() when success != null:
return success(_that.field0);case RetrieveAllAvailableStudentsOutcome_Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<StudentSummaryDto> field0)  success,required TResult Function( ErrorReportDto field0)  failure,}) {final _that = this;
switch (_that) {
case RetrieveAllAvailableStudentsOutcome_Success():
return success(_that.field0);case RetrieveAllAvailableStudentsOutcome_Failure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<StudentSummaryDto> field0)?  success,TResult? Function( ErrorReportDto field0)?  failure,}) {final _that = this;
switch (_that) {
case RetrieveAllAvailableStudentsOutcome_Success() when success != null:
return success(_that.field0);case RetrieveAllAvailableStudentsOutcome_Failure() when failure != null:
return failure(_that.field0);case _:
...
class RetrieveAllAvailableStudentsOutcome_Success extends RetrieveAllAvailableStudentsOutcome {
  const RetrieveAllAvailableStudentsOutcome_Success(final  List<StudentSummaryDto> field0): _field0 = field0,super._();
  

 final  List<StudentSummaryDto> _field0;
@override List<StudentSummaryDto> get field0 {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RetrieveAllAvailableStudentsOutcome_Success&&const DeepCollectionEquality().equals(other._field0, _field0));
}
...
@override
String toString() {
  return 'RetrieveAllAvailableStudentsOutcome.success(field0: $field0)';
}
...
class RetrieveAllAvailableStudentsOutcome_Failure extends RetrieveAllAvailableStudentsOutcome {
  const RetrieveAllAvailableStudentsOutcome_Failure(this.field0): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RetrieveAllAvailableStudentsOutcome_Failure&&(identical(other.field0, field0) || other.field0 == field0));
}
...
@override
String toString() {
  return 'RetrieveAllAvailableStudentsOutcome.failure(field0: $field0)';
}
...
return invalid(_that.field0);case _:
  return orElse();
...
class StudentPositionDto_Invalid extends StudentPositionDto {
  const StudentPositionDto_Invalid(this.field0): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StudentPositionDto_Invalid&&(identical(other.field0, field0) || other.field0 == field0));
}
...
@override
String toString() {
  return 'StudentPositionDto.invalid(field0: $field0)';
}
